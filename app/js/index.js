...
VideoPlayer.prototype.addAnimate2 = function () {
  ...
  animateCss += '}' +
    '.animate3{animation: animate3 4.8s linear;}';
  animateCss += '@keyframes animate-end {' +
    '  from {' +
    'transform: translate('+ animation.position.percent.x[119] +'%,'+ animation.position.percent.y[119]+
    '% )scale('+ animation.scale[119]+')rotate('+ animation.rotation[0] +'deg);'+
    '    opacity: 1; }' +
    '  to {' +
    '    opacity: 0;' +
    'transform: translate('+ animation.position.percent.x[119] +'%,'+ animation.position.percent.y[119]+
